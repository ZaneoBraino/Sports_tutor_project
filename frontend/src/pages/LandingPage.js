	...
	return (
		<>
			...
			<div class="inbetweenText">
				...
				<p>
					We are an orginization to set up athletes like yourself to
					improve upon your skills or if you're a already seasoned
					player to pass on you knowledge and make a bit of money
					while you're at it.
				</p>
				<p>
					Down below you'll find links to either login or sign up as a
					new user in our program.
				</p>
			</div>
			...
			<div class="card-group">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">
							If you're an athlete, you can click here to sign up
							and get yourself a coach today!
						</p>
						<Link to="/Register">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">
							If you're a coach looking to make some money, you
							can sign up here!
						</p>
						<Link to="/SignUp">
							<button class="signup_page_buttons">Sign up</button>
